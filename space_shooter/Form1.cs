...
namespace space_shooter
{
    public partial class Form1 : Form
    {
        ...
        int backgroundSpeed, playerSpeed, bulletSpeed, enemySpeed, enemiesBulletSpeed, score, level, difficulty;
        Random rnd;
            ...
            for (int i = 0; i < enemies.Length; i++)
            {
                if ((bullets[0].Bounds.IntersectsWith(enemies[i].Bounds))  || (bullets[1].Bounds.IntersectsWith(enemies[i].Bounds))) {
                    ...
                    if (score % 30 == 0)
                    {
                        ...
                        if (enemySpeed < 11 && enemiesBulletSpeed < 11 && difficulty != 0)
                        {
                            difficulty--;
                            enemySpeed++;
                            enemiesBulletSpeed++;
                ...
                if (level == 10)
                {
                    GameOver("Game Finished nice gaming");
                }
                ...
                if (Player.Bounds.IntersectsWith(enemies[i].Bounds)) {
                    ...
                    GameOver("Game over for crash with enemy viechle");
                }
                ...
                if (Player.Bounds.IntersectsWith(enemiesBullets[i].Bounds))
                {
                    ...
                    crashMedia.controls.play();
                    Player.Visible = false;
                    GameOver("Game over for recive bullet from enemie");
                }
            }
        }
